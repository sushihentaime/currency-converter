...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const currencyData: MidMarketData = result.data;

    const baseCurrencyData = currencyData.rates[baseCurrency];
    console.log(baseCurrencyData);
    const targetCurrencyData = currencyData.rates[targetCurrency];
    console.log(targetCurrencyData);
    ...
    if (baseCurrency === targetCurrency) {
      ...
      expectedRate = 1/targetCurrencyData;
      ...
      expectedRate = baseCurrencyData / targetCurrencyData
      console.log(`Expected rate: ${expectedRate}`);
      expectedAmount = parsedAmount * expectedRate;
      receivedAmount = parsedAmount * parsedRate;
      console.log(`Expected amount: ${expectedAmount}`);
